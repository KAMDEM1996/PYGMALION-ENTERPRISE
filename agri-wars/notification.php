      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown megamenu"><a href="#"><div style=" font-weight: bold; color: Black;" class="icon"><i class="bi bi-bell-fill" style="font-size: 50px;"></i></div> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li>
                <a href="Encyclopédie.php">Céllule de Notification d'Insertion des Encyclopédies </a>
                <a href="#">Céllule de Notification d'Insertion des Encadreurs</a>
              </li>
            </ul>
          </li>
          </li> 

          <li><a class="nav-link scrollto" href="notification.php#contact"><div style=" font-weight: bold; color: Black;" class="icon"><i class="bi bi-person-badge-fill"style="font-size: 50px;"></i></div></a></li>
        </ul>
...
<p><form method="post" id="comment_form">
<p><div class="form-group"></p>
    <p><label>Entrer Sujet</label></p>
    <input type="text" name="subject" id="subject" class="form-control">
   </div></p>
   <p><div class="form-group">
    <p><label>Entrer Commentaire</label></p>
...
echo ' <tr>
      ...
      <td>'.$comment_status.'</td>
         ...
         <button class="btn btn-danger"><a href="SUPPRIMERNot.php? SUPPRIMERid='.$comment_id.' " class="text-light">Supprimer</a></button>
