...
if($moveIsOk) {
  ...
  echo $idU;
   ...
   if(isset($Valider)){
      ...
      elseif(empty($mail)) $erreur="Email laissé vide!";
  ...
  $sql = "UPDATE user SET nom='$nom',prenom='$prenom',contact='$contact',mail='$mail',pseudo='$pseudo', 
  pays='$pays',ville='$ville',image='$cheminEtNomDefinitif',mdp='$mdp' WHERE idU=". $_SESSION["identifiant"];
...
<div class="erreur"><?php echo $erreur ?></div>
    ...
    <div class="col-md-6 form-group">
      ...
      <p><input type="email" class="form-control is-valid" id="mail" placeholder="E-mail" name="mail" value="<?php echo $mail?>" /></p>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
