        ...
        <div class="row g-0">
          ...
          <div class="col-lg-6">
            <div class="content d-flex flex-column justify-content-center h-100">
              ...
              <ul style=" font-weight: bold;">
                <li><i class="bi bi-check-circle"><a href="ListeProd.php"><span> <spam>  Listes des Produits </spam> </span></a></i></li>               
                <li><i class="bi bi-check-circle"><a href="ApproProd.php"><span>  Approvisionnement Des Produits </span></a></i></li>
                <li><i class="bi bi-check-circle"><a href="DistProd.php"><span>  Distribution Des Produits </span></a></i></li>
                <li><i class="bi bi-check-circle"><a href="SortieProd.php"><span> Sortie Des Produits </span></a></i></li>
              </ul><br/>
          ...
          <div class="col-lg-6">
            <div class="content d-flex flex-column justify-content-center h-100">
              ...
              <ul style=" font-weight: bold;">
                <li><i class="bi bi-check-circle"><a href="AjoutProd.php"><span>  Ajouter Produits </span></a></i></li>
                <li><i class="bi bi-check-circle"><a href="SuppProd.php"><span>  Suppression Des Produits </span></a></i></li>
                <li><i class="bi bi-check-circle"><a href="ModProd.php"><span> Modification Des Produits </span></a></i></li>
              </ul><br/>
            </div>
          </div>
