...
if(isset($_POST['Valider'])){
  ...
  $sqlq = "SELECT * FROM produit";
  $resultq=mysqli_query($con,$sqlq);

  $sql ="UPDATE produit SET codeprod='$codeprod',libelle='$libelle',qteprod='$qteprod',puprod='$puprod',categorie='$categorie',image='$cheminEtNomDefinitif' WHERE idProd =". $_POST['idProd'];
  $result=mysqli_query($con,$sql);
...
<input type="text" class="form-control"  id="libelle" name="libelle" aria-describedby="nameHelp" placeholder="description du Fichier à enrégistrer!">
<small id="nameHelp" class="form-text text-muted"> Libelle Produit.</small>
</div></p>

<p><div class="form-group">
<p><label >Quantite Produit</label></p>
<input type="text" class="form-control"  id="qteprod" name="qteprod" aria-describedby="nameHelp" placeholder="description du Fichier à enrégistrer!">
<small id="nameHelp" class="form-text text-muted"> Qte Produit.</small>
</div></p>

<p><div class="form-group">
<p><label >Prix Unitaire Produit</label></p>
<input type="text" class="form-control"  id="puprod" name="puprod" aria-describedby="nameHelp" placeholder="description du Fichier à enrégistrer!">
<small id="nameHelp" class="form-text text-muted"> Pu Produit.</small>
</div></p>

<p><div class="form-group">
<p><label >Catégorie Produit</label></p>
<input type="text" class="form-control"  id="categorie" name="categorie" aria-describedby="nameHelp" placeholder="description du Fichier à enrégistrer!">
...
<table class="table" style="background-color:white" border="0">
  ...
  <thead>
    ...
    <tr style="height: 21px; font-weight: bold;">
      <th  scope="col">#</th>
      <th  scope="col">codeprod</th>
      <th  scope="col">libelle</th>
      <th  scope="col">qteprod</th>
      <th  scope="col">puprod</th>
