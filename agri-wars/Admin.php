          ...
          <li class="dropdown megamenu"><a href="#"><div style=" font-weight: bold; color: Black;" class="icon"><i class="bi bi-bell-fill" style="font-size: 50px;"></i></div> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li>
                ...
                <a href="publicite.php"> Notification d'Insertion Publicitaires</a>
...
<div></div>
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-item">
              ...
              <div class="details position-relative">
                ...
                <a href="Produits.php" class="stretched-link">
                  <h3>Les Produits</h3>
                </a>
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="600">
            <div class="service-item">
              ...
              <div class="details position-relative">
                ...
                <a href="MainOeuvre.php" class="stretched-link">
                  <h3>Proprietaires de Tracteurs</h3>
                </a>
                <p>Les Proprietaires de Tracteurs.</p>
                <a href="Tracteurs.php" class="stretched-link"></a>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="700">
            <div class="service-item">
              ...
              <div class="details position-relative">
                ...
                <a href="AgriLearning.php" class="stretched-link">
                  <h3>Un service d'Apprentissage</h3>
                </a>
                <p>Gestion E-Learning.</p>
    ...
    </section><!-- End Services Section --></p>
