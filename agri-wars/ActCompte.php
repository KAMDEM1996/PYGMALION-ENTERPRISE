      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown megamenu"><a href="#"><div style=" font-weight: bold; color: Black;" class="icon"><i class="bi bi-people" style="font-size: 50px;"></i></div> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li>
                <a href="Userfree.php">Utilisateurs</a>
              </li>
            </ul>
          </li>
...
<p><div><span><h5 href="#" class="btn btn-info"> <samp>Cellule d'Activation des Comptes Utilisateurs .</samp> </h5></span></div></p>


<!-- ======= Section ======= -->
<section  class="container-fluid p-0">

 <p><div><span><h5 href="#" class="btn btn-secondary"> <samp>Cellule des Utilisateurs.</samp> </h5></span></div></p>   

<div class="container-fluid p-0" data-aos="fade-up">
<p><div class="card-group" >
<?php                         
include("conn.php"); 
$sqla = " SELECT * FROM free  ";
  ...
  <div class="card  <?php if($acte==1){echo 'active';} ?>" >
    ...
    <div class="card-body" style="color: black; font:bold; font-weight: bold; ">
      ...
      <h5 class="card-title">#<?php echo $values["idf"];?> <samp></samp> <small class="text-muted"><?php 
       echo '<button class="btn btn-primary"><a href="Active.php? Activeid='.$values["idf"].' "class="text-light"><span> Activer Comptes </span></a></button>';  ?></small></h5> 
      <h5 class="card-text"><small class="text-muted"><?php 
       echo '<button class="btn btn-success" id="btn" value="Download"><a href="'.$values["fichiers"].'" download class="text-light"><span> télecharger recu de payement</span></a></button>'; } ?></small>
     </h5><br> 
...
$acte++; ?>
  ...
  <div class="card  <?php if($acte==1){echo 'active';} ?>" >
    ...
    <div class="card-body" style="color: black; font:bold; font-weight: bold; ">
      ...
      <h5 class="card-title"><?php echo $values["contact"];?></h5> 
      <h5 class="card-title">Pseudo:<?php echo $values["pseudo"];?></h5>
      <h5 class="card-title">Formation:<?php echo $values["formation"];?></h5>
      <h5 class="card-title"><?php echo $values["mail"];?></h5>  
       <h5 class="card-title"><?php echo $values["pays"];?></h5> 
       <h5 class="card-title"><?php echo $values["ville"];?></h5>  
      <h5 class="card-title">#<?php echo $values["idt"];?> <samp></samp> <small class="text-muted"><?php 
       echo '<button class="btn btn-primary"><a href="ActiveT.php? Activeid='.$values["idt"].' "class="text-light"><span> Activer Comptes </span></a></button>';  ?></small></h5> 
      <h5 class="card-text"><small class="text-muted"><?php 
       echo '<button class="btn btn-success" id="btn" value="Download"><a href="'.$values["fichiers"].'" download class="text-light"><span> télecharger Attestation/Certification</span></a></button>'; } ?></small>
     </h5><br> 
