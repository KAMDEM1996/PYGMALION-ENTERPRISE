...
<div class="success"><?php echo $success ?></div></div></p>
  ...
  <p><div  class="container" style="overflow-x: scroll; overflow-y:  hidden; border:#000000 1px ">
...
$idAd=$row['idAd'];
$NomAd =$row['NomAd'];
$PrenomAd=$row['PrenomAd'];
echo ' <tr>
      <th scope="row">'.$idAd.'</th>
      <td>'.$NomAd.'</td>
      <td>'.$PrenomAd.'</td>
         <td>       
         <button class="btn btn-danger"><a href="SupprimeAdmin.php? SUPPRIMERid='.$idAd.' " class="text-light">Supprimer</a></button>
