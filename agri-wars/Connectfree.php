<?php
   ...
   if(isset($valider)){
      include("conn.php");
      $sel=$bd->prepare("SELECT * FROM user WHERE mail=? AND mdp=? limit 1");
      //$sel=$bd->prepare("SELECT * FROM admin WHERE 1");
      $sel->execute(array($mail,$mdp));
      $tab=$sel->fetchAll();
      if(count($tab)>0){
         $_SESSION["prenomNom"]=ucfirst(strtolower($tab[0]["prenom"])).
         " ".strtoupper($tab[0]["nom"]);
         $_SESSION["identifie"]=ucfirst(strtolower($tab[0]["idU"]));
         $_SESSION["identifiant"]=ucfirst(strtolower($tab[0]["idU"]));
         $_SESSION["idU"]=$idU;
 ...
 <p> <!-- ======= Header ======= -->
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    ...
    <a href="index.php" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
      ...
      <a class="btn-getstarted scrollto" href="index.html#about"><div style=" font-weight: bold; position: relative;" class="icon"><i class="bi bi-person-fill"style="font-size: 50px;"></i></div>Admin</a>
    </div>
  </header><!-- End Header --></p>
...
<p><input type="text" class="box-input" name="mail" id="mail" placeholder="mail d'utilisateur" required /></p>
...
<p class="box-register">Vous êtes nouveau ici? <a href="Inscriptions.php">S'inscrire</a></p>
