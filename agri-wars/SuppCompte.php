...
<p><div></div></p>
<p><div class="col-lg-3 col-md-6 footer-links"><h6><?php echo $bienvenue?><span> [ <a href="deconnexion.php">Se déconnecter</a>  ] </span></h6></div></p>
<p><div></div></p></section></p>

<!-- ======= Section ======= -->
<p><section  class="container-fluid p-0">

<p><div><span><h5 href="#" class="btn btn-secondary"> <samp>Cellule des Utilisateurs Activé .</samp> </h5></span></div></p>   

<div class="container-fluid p-0" data-aos="fade-up">
<p><div class="card-group" >
<?php                         
include("conn.php"); 
$sqla = " SELECT * FROM user WHERE idU ";
  ...
  <div class="card  <?php if($acte==1){echo 'active';} ?>" >
    ...
    <div class="card-body" style="color: black; font:bold; font-weight: bold; ">
      ...
      <h5 class="card-title"><?php echo $values["prenom"];?></h5>
       ...
       <h5 class="card-title"><?php echo $values["mail"];?></h5> 
       <h5 class="card-title">Pseudo:<?php echo $values["pseudo"];?></h5> 
       <h5 class="card-title"><?php echo $values["pays"];?></h5> 
       <h5 class="card-title"><?php echo $values["ville"];?></h5>   

      <p  style="font-size: 15px; color: black; font:bold; font-weight: bold; " class="card-text">Date: <?php echo $values["time"];?>.</p>

       <h5 class="card-title">#<?php echo $values["idU"];?> <samp></samp> <small class="text-muted"><?php 
       echo '<button class="btn btn-danger"><a href="SuppressionU.php? Supid='.$values["idU"].' "class="text-light"><span> Supprimer Comptes Définitivement </span></a></button>';  }  ?></small></h5>  
...
<p><div><span><h5 href="#" class="btn btn-secondary"> <samp>Cellule des Formateurs Activés .</samp> </h5></span></div></p>   

<div class="container-fluid p-0" data-aos="fade-up">
<p><div class="card-group" >
<?php                         
include("conn.php"); 
$sqlb = " SELECT * FROM formateurs WHERE idfor ";
$resulte = mysqli_query($con,$sqlb);
$acte = 0; @$idU=$_GET['idfor'];
foreach ($resulte as $keys =>$values ) {
$acte++; ?>
  ...
  <div class="card  <?php if($acte==1){echo 'active';} ?>" >
    ...
    <div class="card-body" style="color: black; font:bold; font-weight: bold; ">
      ...
      <h5 class="card-title"><?php echo $values["prenom"];?></h5>
       ...
       <h5 class="card-title"><?php echo $values["mail"];?></h5> 
       <h5 class="card-title">Pseudo:<?php echo $values["pseudo"];?></h5> 
       <h5 class="card-title">Formateur:<?php echo $values["formation"];?></h5> 
       <h5 class="card-title"><?php echo $values["pays"];?></h5> 
       <h5 class="card-title"><?php echo $values["ville"];?></h5>   

      <p  style="font-size: 15px; color: black; font:bold; font-weight: bold; " class="card-text">Date: <?php echo $values["time"];?>.</p>

       <h5 class="card-title">#<?php echo $values["idfor"];?> <samp></samp> <small class="text-muted"><?php 
       echo '<button class="btn btn-danger"><a href="Suppressionfor.php? Supid='.$values["idfor"].' "class="text-light"><span> Supprimer Comptes Définitivement </span></a></button>';  }  ?></small></h5>  
...
<p><div><span><h5 href="#" class="btn btn-secondary"> <samp>Cellule des Utilisateurs Non Activé .</samp> </h5></span></div></p>   

<div class="container-fluid p-0" data-aos="fade-up">
<p><div class="card-group" >
<?php                         
include("conn.php"); 
$sqlc = " SELECT * FROM free WHERE idf ";
$resulte = mysqli_query($con,$sqlc);
$acte = 0; @$idf=$_GET['idf'];
foreach ($resulte as $keys =>$values ) {
$acte++; ?>
  ...
  <div class="card  <?php if($acte==1){echo 'active';} ?>" >
    ...
    <div class="card-body" style="color: black; font:bold; font-weight: bold; ">
      ...
      <p  style="font-size: 15px; color: black; font:bold; font-weight: bold; " class="card-text">Date: <?php echo $values["time"];?>.</p>
       ...
       <h5 class="card-title">#<?php echo $values["idf"];?> <samp></samp> <small class="text-muted"><?php 
       echo '<button class="btn btn-danger"><a href="Suppressionfree.php? Supid='.$values["idf"].' "class="text-light"><span> Supprimer Comptes Définitivement </span></a></button>';  }  ?></small></h5>  
...
<p><div><span><h5 href="#" class="btn btn-secondary"> <samp>Cellule des Enseignats Non Activé .</samp> </h5></span></div></p>   

<div class="container-fluid p-0" data-aos="fade-up">
<p><div class="card-group" >
<?php                         
include("conn.php"); 
$sqle = " SELECT * FROM teacher WHERE idt ";
  ...
  <div class="card  <?php if($acte==1){echo 'active';} ?>" >
    ...
    <div class="card-body" style="color: black; font:bold; font-weight: bold; ">
      ...
      <p  style="font-size: 15px; color: black; font:bold; font-weight: bold; " class="card-text">Date: <?php echo $values["time"];?>.</p>
       ...
       <h5 class="card-title">#<?php echo $values["idt"];?> <samp></samp> <small class="text-muted"><?php 
       echo '<button class="btn btn-danger"><a href="SuppressionT.php? Supid='.$values["idt"].' "class="text-light"><span> Supprimer Comptes Définitivement </span></a></button>';  }  ?></small></h5>  
