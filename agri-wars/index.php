...
$result = $conn->query("SELECT image FROM publicite");
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="pricing-item">
              ...
              <ul>
                <li><i class="bi bi-dot"></i> <span>Partager vos connaissances</span></li>
                <li><i class="bi bi-dot"></i> <span>aApprenez des autres</span></li>
              </ul>

              <div class="text-center mt-auto">
                <a href="formateurs.php" class="buy-btn">Inscrivez-vous!</a>
              </div>
          ...
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200" backgroundcolor="gree">
            <div class="pricing-item">

              <div class="pricing-header">
                <h3>Propriétaire d'engins</h3>
                <h4><sup>$</sup>0<span> / month</span></h4>
              </div>

              <ul>
                <li><i class="bi bi-dot"></i> <span>Louer vos engins</span></li>
                <li><i class="bi bi-dot"></i> <span>Faites vous de l'argent</span></li>
              </ul>

              <div class="text-center mt-auto">
                <a href="ProprietataireEngins.php" class="buy-btn">Inscrivez-vous!</a>
              </div>
