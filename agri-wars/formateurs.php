...
@$attestation = $_POST['nom'].'.'.$extension;

@$cheminEtNomDefinitif2 = 'attestation/'.$attestation;
...
if($moveIsOk) {
  ...
  @$erreur="";
   ...
   if(isset($Valider)){
      ...
      elseif(empty($formation)) $erreur="formation laissé vide!";
      elseif(empty($mdp)) $erreur="Mot de passe laissé vide!";
      elseif($mdp!=$repass) $erreur="Mots de passe non identiques!";
      else{
         include("conn.php");
         $sel=$bd->prepare("SELECT idt FROM teacher WHERE mail=? LIMIT 1");
        ...
        fputs($fp,$nom.":".$prenom.":".$contact.":".$mail.":".$pseudo.":".$pays.":".$ville.":".$cheminEtNomDefinitif.":".$cheminEtNomDefinitif2.":".md5($mdp)."\r\n"); 
            ...
            $ins=$bd->prepare("INSERT INTO teacher(nom,prenom,contact,mail,pseudo,pays,ville,image,fichiers,formation,mdp) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
            if($ins->execute(array($nom,$prenom,$contact,$mail,$pseudo,$pays,$ville,$cheminEtNomDefinitif,$cheminEtNomDefinitif2,$formation,md5($mdp))))
...
<div class="erreur"><?php echo $erreur ?></div>
    ...
    <div class="col-md-6 form-group">
      <p><div class="form-button">
      <p><label for="image">Attestation de Formation</label></p>
...
<div class="col-md-6 form-group">
<p><label for="formation">formation</label></p>
<fieldset>
<legend><b>Selectionnez votre formation</b></legend>
<input type="checkbox" name="formation" id="formation" value="Elevage" />élevage<br/>
<input type="checkbox" name="formation" id="formation" value="Agriculture" />agricole<br/>
<?php   
if(isset($_POST["formation"]))
{
   foreach($_POST["formation"] as $value)
   {
    echo $value = $formation  ."<br>";  
    echo $value ."<br>";
   }
} ?>
</fieldset>
